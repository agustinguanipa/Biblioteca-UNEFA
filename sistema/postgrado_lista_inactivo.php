	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tab_postgr WHERE statu_post = 0");
							...
							$query = mysqli_query($conexion,"SELECT u.ident_post, u.titul_post, u.autor_post, u.fecre_post, u.archi_post, u.tipo_post, r.ident_espe, r.nombr_espe FROM tab_postgr u INNER JOIN tab_especi r ON u.ident_espe = r.ident_espe WHERE statu_post = 0  ORDER BY ident_post ASC LIMIT $desde,$por_pagina");
