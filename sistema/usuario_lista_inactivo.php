	...
	<div class="table-wrapper">
	    ...
	    <div class="row" style="padding-top: 2px;">
	    	<div class="col-sm-8">
				...
				<form action="usuario_buscar_inactivos.php" method="GET" class="col-sm-4" style="padding-top: 1px;">
	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tab_usuar WHERE statu_usua = 0");
							...
							$query = mysqli_query($conexion,"SELECT u.ident_usua, u.nombr_usua, u.apeli_usua, u.email_usua, u.usuar_usua, u.fotou_usua, r.nombr_tipu FROM tab_usuar u INNER JOIN tab_tipusu r ON u.ident_tipu = r.ident_tipu WHERE statu_usua = 0  ORDER BY ident_usua ASC LIMIT $desde,$por_pagina");
							 		...
							 		<tr class="row<?php echo $data['ident_usua']; ?>">
										...
										<td class='text-center'>
											<?php  
												...
												?>
													<a href="usuario_restaurar.php?id=<?php echo $data['ident_usua']; ?>" class="restaurar"><i class="fa fa-check"></i></a>
