...
$id = $_GET['id'];
	...
	$query_user = mysqli_query($conexion,"SELECT u.ident_preg,u.titul_preg, u.autor_preg, u.tipo_preg, r.ident_carr, r.nombr_carr FROM tab_pregra u INNER JOIN tab_carrer r ON u.ident_carr = r.ident_carr WHERE ident_preg = '$id' AND statu_preg = 1");
  ...
  <div class="form-group text-center">
    <div class="card">
    	<div class="card-header">
			    <b>Eliminar Trabajo de Pre-Grado</b>
			  </div>
		   	<div class="card-body">
  				<form role="form" id="pregrado_eliminar" class="justify-content-center mx-3 my-1" align="center" enctype="" action="pregrado_proceso_eliminar.php" method="post">
