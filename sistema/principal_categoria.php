...
<?php 
 ...
 $perpage = 12;
  ...
  $PageSql = "SELECT * FROM tab_catego WHERE statu_cate = 1";
  ...
  $ReadSql = "SELECT * FROM tab_catego WHERE statu_cate = 1 LIMIT $start, $perpage";
  $res = mysqli_query($conexion, $ReadSql);

?>

<head>
  <title>Categorías de Libros | Biblioteca UNEFA Táchira</title>
</head>
    ...
    <div class="container my-3">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
             <a href="principal_libro.php" class="btn-sm btn-outline-primary float-right my-3">Ver Todos <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
      <hr class="my-4">
