...
<div class="container-fluid">
	<div class="table-wrapper">
	    ...
	    <div class="row" style="padding-top: 2px;">
	    	<div class="col-sm-8">
					<a href="carreras_registro.php" class="btn btn-success float-left"><i class="fa fa-plus"></i> Registrar Carrera</a>
				</div>
	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tab_carrer WHERE statu_carr = 1");
							...
							$query = mysqli_query($conexion,"SELECT ident_carr, nombr_carr FROM tab_carrer  WHERE statu_carr = 1  ORDER BY ident_carr ASC LIMIT $desde,$por_pagina");
