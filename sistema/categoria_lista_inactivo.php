	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tab_catego WHERE statu_cate = 0");
							...
							$query = mysqli_query($conexion,"SELECT ident_cate, nombr_cate FROM tab_catego  WHERE statu_cate = 0  ORDER BY ident_cate ASC LIMIT $desde,$por_pagina");
							 	...
							 	while ($data = mysqli_fetch_array($query)) {
							 		...
							 		<tr class="row<?php echo $data['ident_cate']; ?>">
										...
										<td class='text-center'>
											<a href="categoria_restaurar.php?id=<?php echo $data['ident_cate']; ?>" class="restaurar"><i class="fa fa-check"></i></a>
										</td>
									</tr>
