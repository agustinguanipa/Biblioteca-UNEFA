	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$query = mysqli_query($conexion,"SELECT u.ident_libr, u.nombr_libr, u.autor_libr, u.fecre_libr, r.nombr_cate FROM tab_libros u INNER JOIN tab_catego r ON u.ident_cate = r.ident_cate WHERE 
								(u.ident_libr LIKE '%$busqueda%' OR
								u.nombr_libr LIKE '%$busqueda%' OR
								u.autor_libr LIKE '%$busqueda%' OR
								r.nombr_cate LIKE '%$busqueda%')
								AND	statu_libr = 0  ORDER BY ident_libr ASC LIMIT $desde,$por_pagina");
							 	...
							 	while ($data = mysqli_fetch_array($query)) {
							 		...
							 		<tr class="row<?php echo $data['ident_libr']; ?>">
										...
										<td class='text-center'>
											<a href="libro_restaurar.php?id=<?php echo $data['ident_libr']; ?>" class="look"><i class="fa fa-check"></i></a>
										</td>
