	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tab_usuar WHERE statu_usua = 1");
							...
							$query = mysqli_query($conexion,"SELECT u.ident_usua, u.nombr_usua, u.apeli_usua, u.email_usua, u.usuar_usua, u.fotou_usua, r.nombr_tipu FROM tab_usuar u INNER JOIN tab_tipusu r ON u.ident_tipu = r.ident_tipu WHERE statu_usua = 1  ORDER BY ident_usua ASC LIMIT $desde,$por_pagina");
							 		...
							 		<tr class="row<?php echo $data['ident_usua']; ?>">
										...
										<td class='text-center'>
											<?php  
												...
												?>
													<a href="usuario_borrar.php?id=<?php echo $data['ident_usua']; ?>" class="delete eliminar"><i class="fa fa-trash-alt"></i></a>
