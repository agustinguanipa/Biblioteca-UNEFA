	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tab_libros WHERE statu_libr = 1");
							...
							$query = mysqli_query($conexion,"SELECT u.ident_libr, u.nombr_libr, u.autor_libr, u.fecre_libr, u.archi_libr, r.nombr_cate FROM tab_libros u INNER JOIN tab_catego r ON u.ident_cate = r.ident_cate WHERE statu_libr = 1  ORDER BY ident_libr ASC LIMIT $desde,$por_pagina");
