  ...
  <div class="form-group text-center">
    <div class="card">
    	<div class="card-header">
		   	...
		   	<div class="card-body">
  				<form role="form" id="categoria_editar" class="justify-content-center mx-3 my-1" align="center" enctype="" action="categoria_proceso_eliminar.php" method="post">
		        ...
		        <div class="form-row">
		          <div class="col form-group">
		            <button type="submit" id="" class="btn btn-danger btn-block"><i class="fa fa-trash"></i> Eliminar Categoria</button>
		          </div>
		        </div>
		      </form>
				</div>
