<?php
  ...
  if (!empty($_SESSION['active'])) {
	...
	require_once('sistema/includes/logreg_header.php');
?>
...
<div class="container">
    <div class="form-group text-center">
      <div class="formulario-registro-inicio">
        <form role="form" id="usuario_registro" class="justify-content-center mx-3 my-1" align="center" enctype="multipart/form-data" action="ajax/guardar_estudiante.php" method="post">
          <h3>Registrarse</h3>
          <hr class="my-4">
            <div class="form-row">
            ...
            <div class="form-row">
              <div class="col form-group">
                <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-user"></i> Registrarse</button>
