...
<?php 
 ...
 $perpage = 4;
  ...
  $PageSql = "SELECT * FROM tab_postgr WHERE statu_post = 1";
  ...
  $ReadSql = "SELECT u.ident_post, u.titul_post, u.autor_post, u.tipo_post, u.archi_post, u.fecre_post, r.ident_espe, r.nombr_espe FROM tab_postgr u INNER JOIN tab_especi r ON u.ident_espe = r.ident_espe WHERE statu_post = 1 LIMIT $start, $perpage";
    ...
    <div class="container my-3">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
            <h1 align="center">Trabajos de Post-Grado</h1>
          </div>
          <div class="col-sm-4">
             <a href="principal_especializaciones.php" class="btn-sm btn-outline-primary float-right my-3">Ir a Especializaciones <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
      <hr class="my-4">
              ...
              <div class="card card-product">
                <div class="img-wrap"><img src="<?php echo $foto; ?>" width="100"></div>
                  <figcaption class="info-wrap" scope="r">
                    ...
                    <p class="desc"><?php echo $row['tipo_post'] ?></p>
                    <p class="desc"><?php echo $row['nombr_espe'] ?></p>
                  </figcaption>
