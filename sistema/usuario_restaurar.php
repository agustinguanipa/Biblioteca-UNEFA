...
$id = $_GET['id'];
	...
	$query_user = mysqli_query($conexion,"SELECT u.ident_usua,u.nombr_usua, u.apeli_usua, u.email_usua, u.usuar_usua, u.fotou_usua, r.ident_tipu, r.nombr_tipu FROM tab_usuar u INNER JOIN tab_tipusu r ON u.ident_tipu = r.ident_tipu WHERE ident_usua = '$id' AND statu_usua = 0");
    ...
    <div class="card">
    	<div class="card-header">
		   	...
		   	<div class="card-body">
		        ...
		        <div class="form-row">
		          <div class="col form-group">
		            <button type="submit" class="btn btn-success btn-block"><i class="fa fa-check"></i> Restaurar Usuario</button>
		          </div>
		        </div>
		      </form>
				</div>
				<div class="card-footer">
           <a href="usuario_lista_inactivo.php" class="btn btn-primary float-left"><i class="fa fa-arrow-left"></i> Volver al Listado</a> 
				</div>
    </div> 
  </div>
</div>
