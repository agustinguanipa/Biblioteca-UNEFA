	    	...
	    	<div class="table-responsive">
					<table class="table table-striped table-hover">
						...
						//Paginador 
							...
							$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tab_pregra WHERE statu_preg = 0");
							...
							$query = mysqli_query($conexion,"SELECT u.ident_preg, u.titul_preg, u.autor_preg, u.fecre_preg, u.archi_preg, u.tipo_preg, r.nombr_carr FROM tab_pregra u INNER JOIN tab_carrer r ON u.ident_carr = r.ident_carr WHERE statu_preg = 0  ORDER BY ident_preg ASC LIMIT $desde,$por_pagina");
